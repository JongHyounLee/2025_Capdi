...
/******************************************************************************/
#define AI_MYMODEL_MODEL_NAME          "mymodel"
#define AI_MYMODEL_ORIGIN_MODEL_NAME   "tcn_cubeai_ready"

/******************************************************************************/
#define AI_MYMODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MYMODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MYMODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MYMODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_MYMODEL_IN \
  ai_mymodel_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MYMODEL_IN_SIZE { \
  AI_MYMODEL_IN_1_SIZE, \
}
#define AI_MYMODEL_IN_SIZE_BYTES { \
  AI_MYMODEL_IN_1_SIZE_BYTES, \
}
#define AI_MYMODEL_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MYMODEL_IN_1_HEIGHT      (128)
#define AI_MYMODEL_IN_1_CHANNEL     (8)
#define AI_MYMODEL_IN_1_SIZE        (1024)
#define AI_MYMODEL_IN_1_SIZE_BYTES  (4096)

/******************************************************************************/
#define AI_MYMODEL_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MYMODEL_OUT \
  ai_mymodel_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MYMODEL_OUT_SIZE { \
  AI_MYMODEL_OUT_1_SIZE, \
}
#define AI_MYMODEL_OUT_SIZE_BYTES { \
  AI_MYMODEL_OUT_1_SIZE_BYTES, \
}
#define AI_MYMODEL_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MYMODEL_OUT_1_CHANNEL     (2)
#define AI_MYMODEL_OUT_1_SIZE        (2)
#define AI_MYMODEL_OUT_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_MYMODEL_N_NODES (31)
 ...
 * @ref ai_mymodel_create. Both the activations memory buffer 
 ...
 * using @ref ai_mymodel_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_mymodel_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_mymodel_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MYMODEL_*
 * defines into file @ref mymodel.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
