...
#define AI_IMU_MODEL_MODEL_SIGNATURE     "0xb3a67c3a5ec364e284c2ba960c46b2d7"
...
#define AI_TOOLS_DATE_TIME   "2025-11-16T06:36:56+0900"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    123648, NULL, NULL),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_IMU_MODEL_IN_NUM, &input_layer_output),
  AI_TENSOR_LIST_IO_OBJ_INIT(AI_FLAG_NONE, AI_IMU_MODEL_OUT_NUM, &dense_1_output),
  &conv1d_layer, 0x90c0b0fe, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_imu_model_activations_map, 1, params)) {
    ...
    input_layer_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 62616);
    input_layer_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 62616);
    conv1d_scratch0_array.data = AI_PTR(g_imu_model_activations_map[0] + 77976);
    conv1d_scratch0_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 77976);
    conv1d_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 78336);
    conv1d_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 78336);
    activation_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 78336);
    activation_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 78336);
    conv1d_1_scratch0_array.data = AI_PTR(g_imu_model_activations_map[0] + 77568);
    conv1d_1_scratch0_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 77568);
    conv1d_1_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 44800);
    conv1d_1_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 44800);
    activation_1_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 44800);
    activation_1_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 44800);
    conv1d_2_scratch0_array.data = AI_PTR(g_imu_model_activations_map[0] + 111104);
    conv1d_2_scratch0_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 111104);
    conv1d_2_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 43776);
    conv1d_2_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 43776);
    add_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 78336);
    add_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 78336);
    activation_2_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 78336);
    activation_2_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 78336);
    zero_padding1d_2_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 43776);
    zero_padding1d_2_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 43776);
    conv1d_3_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 43520);
    conv1d_3_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 43520);
    activation_3_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 43520);
    activation_3_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 43520);
    zero_padding1d_3_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 42496);
    zero_padding1d_3_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 42496);
    conv1d_4_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 42240);
    conv1d_4_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 42240);
    add_1_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 42240);
    add_1_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 42240);
    activation_4_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 79104);
    activation_4_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 79104);
    zero_padding1d_4_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 44288);
    zero_padding1d_4_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 44288);
    conv1d_5_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 44032);
    conv1d_5_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 44032);
    activation_5_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 44032);
    activation_5_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 44032);
    zero_padding1d_5_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 41984);
    zero_padding1d_5_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 41984);
    conv1d_6_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 41728);
    conv1d_6_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 41728);
    add_2_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 41728);
    add_2_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 41728);
    activation_6_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 41728);
    activation_6_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 41728);
    conv1d_9_scratch0_array.data = AI_PTR(g_imu_model_activations_map[0] + 41472);
    conv1d_9_scratch0_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 41472);
    conv1d_9_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 74496);
    conv1d_9_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 74496);
    zero_padding1d_6_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 37632);
    zero_padding1d_6_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 37632);
    conv1d_7_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 24320);
    conv1d_7_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 24320);
    activation_7_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 24320);
    activation_7_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 24320);
    zero_padding1d_7_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 18176);
    zero_padding1d_7_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 18176);
    conv1d_8_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 17792);
    conv1d_8_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 17792);
    add_3_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 74496);
    add_3_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 74496);
    activation_8_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 74496);
    activation_8_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 74496);
    zero_padding1d_8_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 13056);
    zero_padding1d_8_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 13056);
    conv1d_10_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 12672);
    conv1d_10_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 12672);
    activation_9_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 12672);
    activation_9_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 12672);
    zero_padding1d_9_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 384);
    zero_padding1d_9_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 384);
    conv1d_11_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 0);
    conv1d_11_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 0);
    add_4_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 74496);
    add_4_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 74496);
    activation_10_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 0);
    activation_10_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 0);
    global_average_pooling1d_pool_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 49152);
    global_average_pooling1d_pool_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 49152);
    ...
    dense_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 512);
    dense_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 512);
    dense_1_dense_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 0);
    dense_1_dense_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 0);
    dense_1_output_array.data = AI_PTR(g_imu_model_activations_map[0] + 16);
    dense_1_output_array.data_start = AI_PTR(g_imu_model_activations_map[0] + 16);
    return true;
  }
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_imu_model_weights_map, 1, params)) {
    ...
    conv1d_bias_array.data = AI_PTR(g_imu_model_weights_map[0] + 23040);
    conv1d_bias_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 23040);
    conv1d_1_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_1_weights_array.data = AI_PTR(g_imu_model_weights_map[0] + 23296);
    conv1d_1_weights_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 23296);
    conv1d_1_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_1_bias_array.data = AI_PTR(g_imu_model_weights_map[0] + 72448);
    conv1d_1_bias_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 72448);
    conv1d_2_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_2_weights_array.data = AI_PTR(g_imu_model_weights_map[0] + 72704);
    conv1d_2_weights_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 72704);
    conv1d_2_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_2_bias_array.data = AI_PTR(g_imu_model_weights_map[0] + 121856);
    conv1d_2_bias_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 121856);
    conv1d_3_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_3_weights_array.data = AI_PTR(g_imu_model_weights_map[0] + 122112);
    conv1d_3_weights_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 122112);
    conv1d_3_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_3_bias_array.data = AI_PTR(g_imu_model_weights_map[0] + 171264);
    conv1d_3_bias_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 171264);
    conv1d_4_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_4_weights_array.data = AI_PTR(g_imu_model_weights_map[0] + 171520);
    conv1d_4_weights_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 171520);
    conv1d_4_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_4_bias_array.data = AI_PTR(g_imu_model_weights_map[0] + 220672);
    conv1d_4_bias_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 220672);
    conv1d_5_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_5_weights_array.data = AI_PTR(g_imu_model_weights_map[0] + 220928);
    conv1d_5_weights_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 220928);
    conv1d_5_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_5_bias_array.data = AI_PTR(g_imu_model_weights_map[0] + 270080);
    conv1d_5_bias_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 270080);
    conv1d_6_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_6_weights_array.data = AI_PTR(g_imu_model_weights_map[0] + 270336);
    conv1d_6_weights_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 270336);
    conv1d_6_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_6_bias_array.data = AI_PTR(g_imu_model_weights_map[0] + 319488);
    conv1d_6_bias_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 319488);
    conv1d_9_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_9_weights_array.data = AI_PTR(g_imu_model_weights_map[0] + 319744);
    conv1d_9_weights_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 319744);
    conv1d_9_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_9_bias_array.data = AI_PTR(g_imu_model_weights_map[0] + 344320);
    conv1d_9_bias_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 344320);
    conv1d_7_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_7_weights_array.data = AI_PTR(g_imu_model_weights_map[0] + 344704);
    conv1d_7_weights_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 344704);
    conv1d_7_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_7_bias_array.data = AI_PTR(g_imu_model_weights_map[0] + 418432);
    conv1d_7_bias_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 418432);
    conv1d_8_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_8_weights_array.data = AI_PTR(g_imu_model_weights_map[0] + 418816);
    conv1d_8_weights_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 418816);
    conv1d_8_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_8_bias_array.data = AI_PTR(g_imu_model_weights_map[0] + 529408);
    conv1d_8_bias_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 529408);
    conv1d_10_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_10_weights_array.data = AI_PTR(g_imu_model_weights_map[0] + 529792);
    conv1d_10_weights_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 529792);
    conv1d_10_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_10_bias_array.data = AI_PTR(g_imu_model_weights_map[0] + 640384);
    conv1d_10_bias_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 640384);
    conv1d_11_weights_array.format |= AI_FMT_FLAG_CONST;
    conv1d_11_weights_array.data = AI_PTR(g_imu_model_weights_map[0] + 640768);
    conv1d_11_weights_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 640768);
    conv1d_11_bias_array.format |= AI_FMT_FLAG_CONST;
    conv1d_11_bias_array.data = AI_PTR(g_imu_model_weights_map[0] + 751360);
    conv1d_11_bias_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 751360);
    dense_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_weights_array.data = AI_PTR(g_imu_model_weights_map[0] + 751744);
    dense_dense_weights_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 751744);
    dense_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_bias_array.data = AI_PTR(g_imu_model_weights_map[0] + 800896);
    dense_dense_bias_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 800896);
    dense_1_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_weights_array.data = AI_PTR(g_imu_model_weights_map[0] + 801408);
    dense_1_dense_weights_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 801408);
    dense_1_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_1_dense_bias_array.data = AI_PTR(g_imu_model_weights_map[0] + 803456);
    dense_1_dense_bias_array.data_start = AI_PTR(g_imu_model_weights_map[0] + 803456);
    return true;
  }
